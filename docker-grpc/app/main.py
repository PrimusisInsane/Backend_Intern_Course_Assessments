...
from app.resolvers.queries import query, task_type, activity_log_type, project_type

from app.models import user_model, project_model, task_model, membership_model

schema = make_executable_schema(type_defs, query, mutation, task_type, activity_log_type, project_type)
