...
Revision ID: 733f0b0d2031
Revises: 
Create Date: 2026-06-17 05:55:54.467681
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('authorization_task_owner_id_cdb1699a'), table_name='authorization_task')
    op.drop_table('authorization_task')
...
def downgrade() -> None:
    ...
    op.create_table('authorization_task',
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['auth_user.id'], name=op.f('authorization_task_owner_id_cdb1699a_fk_auth_user_id'), initially='DEFERRED', deferrable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('authorization_task_pkey'))
    )
    op.create_index(op.f('authorization_task_owner_id_cdb1699a'), 'authorization_task', ['owner_id'], unique=False)
