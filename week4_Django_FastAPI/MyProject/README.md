# Django Reference
- Tested Django Rest Framework, used JWT Token and password authetication to create user and give tasks, can also perform basic CRUD with django admin and 3rd party application like postman.   
...
## Templates 
- HTML docs are pretty unwanted, and is HIGHLY not-recommended to use it. You can create through Django admin itself. 
